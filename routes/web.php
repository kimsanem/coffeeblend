...
Route::group(['prefix' => 'products'], function () {
    ...
    // checkout routes
    Route::post('/prepare-checkout', [ProductController::class, 'prepareCheckout'])->name('prepare.checkout.post');
...
Route::group(['prefix' => 'payments'], function () {
    Route::get('/pay', [ProductController::class, 'pay'])->name('pay')->middleware('check.for.price');
    Route::get('/success', [ProductController::class, 'success'])->name('success')->middleware('check.for.price');
});
