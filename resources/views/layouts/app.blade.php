        ...
        <footer class="ftco-footer ftco-section img">
            ...
            <div class="container">
                ...
                <div class="col-lg-3 col-md-6 mb-5 mb-md-5">
                    ...
                    <p>Our journey began with a simple passion: to bring the finest flavors from farms around the world to your table. With a commitment to quality, sustainability, and authenticity, we ensure that every sip carries not only rich taste but also the heart and dedication of those who make it possible.</p>
                ...
                <div class="col-lg-4 col-md-6 mb-5 mb-md-5">
                    ...
                    <div class="block-21 mb-4 d-flex">
                        ...
                        <div class="text">
                            <h3 class="heading"><a href="#">📖 Your Daily Dose of Coffee & Inspiration</a></h3>
                            <div class="meta">
                    ...
                    <div class="block-21 mb-4 d-flex">
                        ...
                        <div class="text">
                            <h3 class="heading"><a href="#">☕ Brewing Stories, One Cup at a Time</a></h3>
                            <div class="meta">
                                <div><a href="#"><span class="icon-calendar"></span> Sept 15, 2018</a></div>
                                <div><a href="#"><span class="icon-person"></span> Admin</a></div>
                                <div><a href="#"><span class="icon-chat"></span> 19</a></div>
                ...
                <div class="col-lg-3 col-md-6 mb-5 mb-md-5">
                    <div class="ftco-footer-widget mb-4">
                        ...
                        <ul>
                            <li><span class="icon icon-map-marker"></span><span class="text">123 St.2 Phnom Penh, Cambodia</span></li>
                            <li><a href="#"><span class="icon icon-phone"></span><span class="text">+123 456 789</span></a></li>
                            <li><a href="#"><span class="icon icon-envelope"></span><span class="text">cooffeeblend@gmail.com</span></a></li>
                        </ul>
                        </div>
                    </div>
                </div>
