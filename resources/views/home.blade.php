	    			...
	    			<div class="row no-gutters">
	    				...
	    				<div class="col-md-4 d-flex ftco-animate">
	    					...
	    					<div class="text">
	    						...
	    						<p class="text-white">	203 Fake St. Mountain View, San Francisco, California, USA</p>
	    					</div>
	    				</div>
	    				<div class="col-md-4 d-flex ftco-animate">
	    					<div class="icon"><span class="icon-clock-o"></span></div>
	    					<div class="text">
	    						<h3 class="text-white">Open Monday-Friday</h3>
	    						<p class="text-white">8:00am - 9:00pm</p>
	    					</div>
	    				</div>
	    			</div>
	    		</div>
					...
					@foreach ($products as $product)
						...
						<div class="col-md-3">
							<div class="menu-entry">
								...
								<div class="text text-center pt-4 text-white">
